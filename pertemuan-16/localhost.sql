...
--
-- Host: localhost:3306
-- Waktu pembuatan: 22 Jan 2026 pada 10.35
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
(17, '2511500888', 'afdall', 'a', 'aa', 'a', 'a', 'a', 'a', 'a', 'a', '2026-01-22 15:41:59'),
(18, 'awdawdawdaw', 'dawd', 'awdwa', 'dawda', 'awdaw', 'wd', 'aw', 'dwad', 'aw', 'awdaw', '2026-01-22 15:48:28');
...
--
-- Dumping data untuk tabel `tbl_biodata1`
--

INSERT INTO `tbl_biodata1` (`cid`, `nim`, `nama_lengkap`, `tempat_lahir`, `tanggal_lahir`, `hobi`, `pasangan`, `pekerjaan`, `nama_orang_tua`, `nama_kakak`, `nama_adik`, `created_at`) VALUES
(2, 'aawdawdawda', 'awdawd', 'awdawd', 'awdaw', 'dadaw', 'daw', 'daw', 'dawd', 'awdwa', 'daw', '2026-01-22 15:56:11');
...
CREATE TABLE `tbl_biodata_pengunjung` (
  `cid` int NOT NULL,
  `Kode_Pengunjung` varchar(20) DEFAULT NULL,
  `Nama_Pengunjung` varchar(50) DEFAULT NULL,
  `Alamat_Rumah` varchar(50) DEFAULT NULL,
  `Tanggal_Kunjungan` varchar(50) DEFAULT NULL,
  `Hobi` varchar(50) NOT NULL,
  `Asal_SLTA` varchar(100) NOT NULL,
  `Pekerjaan` varchar(50) NOT NULL,
  `Nama_Ortu` varchar(50) NOT NULL,
  `Nama_Pacar` varchar(50) NOT NULL,
  `Nama_Mantan` varchar(50) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data untuk tabel `tbl_biodata_pengunjung`
--

INSERT INTO `tbl_biodata_pengunjung` (`cid`, `Kode_Pengunjung`, `Nama_Pengunjung`, `Alamat_Rumah`, `Tanggal_Kunjungan`, `Hobi`, `Asal_SLTA`, `Pekerjaan`, `Nama_Ortu`, `Nama_Pacar`, `Nama_Mantan`, `created_at`) VALUES
(1, 'awdwadwadawd', 'awdawdawdaw', 'awdawd', 'dadawd', 'a', 'w', 'aa', 'a', 'aa', 'aa', '2026-01-22 17:33:24');
