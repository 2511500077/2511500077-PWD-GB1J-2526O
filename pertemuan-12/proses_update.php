...
#validasi cid wajib angka dan > e
...
} else { #jika gagal, simpan kembali old value dan tampilan eror umum 
    $_SESSION['old'] = [
        'nama' => $nama,
        'email' => $email,
        'pesan' => $pesan,
    ];
$_SESSION['flash_error'] = 'Duta gaagal diperbarui. Silahkan coba lagi.';
redirect_ke('edit.php?cid='. (int)$cid);
}
#tutup statement
